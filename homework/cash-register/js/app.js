...
// 5: Append a new <tr></tr> to the <tbody id="entries"> containing two <td>'s, one of which contains the new variable:
//<tr><td></td><td>NEW VALUE</td></tr>
...
//Function begins when page loads
$(document).ready(function () {

	//define total variable
	var total = 0;

	//Begin function when form is submitted
	$('form').submit(function (event) {

		//Prevent form submission from redirecting
		event.preventDefault();

		//Create a variable to store the user input from #newEntry
